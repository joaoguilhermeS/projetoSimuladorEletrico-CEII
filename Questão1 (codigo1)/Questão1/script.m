...
clear
clc
% utilizaremos variáveis simbólicas para cálculos de parâmetros genéricos no tempo e
% com laplace
syms s
syms t

% lendo o arquivo de entrada
entradaDados = readmatrix('entrada_circ_Q1.txt')
...
%gráfico da tensão no resistor de 1 ohm (numericamente igual a corrente)
figure
plot(t,V_t)
axis([0 tmax -60 60])
set(gca,'FontSize',16)
...
grid()
title ('Tensão no resistor de 1 ohms')
